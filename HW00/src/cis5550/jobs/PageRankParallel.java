...
public class PageRankParallel {
	...
	public static float DECAY = (float) 0.85; public static float CONV_THRESH = (float) 0.01; public static float CONV_P = (float) 0.85;
	...
	public static void run(FlameContext ctx, String[] args) throws Exception {
		...
		PairToPairIterable compute_transfer = s -> {
			...
			if (contents.length == 2) {
				...
				double rank = Double.parseDouble(ranks[0]);
