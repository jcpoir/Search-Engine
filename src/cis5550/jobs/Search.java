...
public class Search {
	...
	public static double[] calc_tf_idf_pr(String term, String document) {
		...
		String url = info[0]; String[] pos = info[1].split(" "); if (pos.length < 1) {return new double[] {0,0.1};}
	...
	public static void run(FlameContext ctx, String[] args) throws IOException {
		...
		for (String word : words) {
			...
			for (String document : documents) {
				...
				double[] scores = calc_tf_idf_pr(word, document);
				double tf_idf = scores[0]; double pagerank = scores[1];
