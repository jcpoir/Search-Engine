...
public class Crawler {
  ...
  public static void run(FlameContext context, String args[]) throws Exception {
    ...
    StringToIterable lambda = (String str) -> {
      ...
      hostRobot = client.get("hosts", hostKey, "robots");
      ...
      // Rate Limiting
      byte[] timeBytes = client.get("hosts", hostKey, "time");
      ...
      if (outsideRateLimit) {
        ...
        client.put("hosts", hostKey, "time", curTimeBytes);
      }
      ...
      client.put("crawl", Hasher.hash(str), "url", str);
      row.put("url", str);
