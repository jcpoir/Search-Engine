...
public class FlameContextImpl implements FlameContext{
  ...
  public FlameRDD fromTable(String tableName, RowToString lambda) throws Exception {
    String newTableName = FlameContextImpl.invokeOperation("POST", "/rdd/fromTable", Serializer.objectToByteArray(lambda),
        tableName, null);
  ...
  public void setConcurrencyLevel(int keyRangesPerWorker) {
    ...
    throw new UnsupportedOperationException("Unimplemented method 'setConcurrencyLevel'");
  }
}
